...
SECRET_KEY = 'django-insecure-u!nrb9&^d6&2))_ysa#2h0!*83^+_)!w4chhieo1fvu23wv8fg'
...
AUTHENTICATION_BACKENDS = [
    'members.backends.MembersBackend',
    'admins.backends.AdminsBackend',
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'e_library',  'db.sqlite3')
    }
}
